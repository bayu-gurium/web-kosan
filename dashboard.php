...
<body class="bg-light">
    ...
    <div class="container">
        ...
        <div class="row mt-4 mt-lg-4 p-3 p-lg-0 align-content-center d-flex" style="height: 50vh;">

            <div class="col-lg-5 mt-lg-5 mt-0 p-4 order-2 order-lg-1">
                <h5>Selamat Datang <strong><?= $_SESSION['nama_user'] ?></strong> 👋👋</h5>
                <p>Sistem Informasi Pengelolaan Data Kos-kosan Batak</p>
                <p>Alamat : </p>

                <footer>
                    <small class="text-muted">&copy; Copyright 2024</small>
                </footer>

            </div>

            <div class="col-lg-7 order-1 order-lg-2 mt-lg-0 mt-3">

                <div class="row">
                    <div class="col-lg-6 col-6">
                        <div class="card shadow border-0 p-3 my-2" style="background-color:#FBAB7E;
                    ...
                    <div class="col-lg-6 col-6">
                        <div class="card shadow border-0 p-3 my-2" style="background-color: #8BC6EC;
                ...
                <div class="row">
                    <div class="col-lg-6 col-6">
                        <div class="card shadow border-0 p-3 my-2" style="background-color: #FAACA8;
                    ...
                    <div class="col-lg-6 col-6">
                        <div class="card shadow border-0 p-3 my-2" style="background-color: #08AEEA;
